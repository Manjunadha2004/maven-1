...
/**
 * Maven Session Root base directory.
 */
public class SessionRootBasedir extends Basedir {
    public static class Builder {
        ...
        @Nonnull
        public SessionRootBasedir build() {
            return new SessionRootBasedir(basedir, conf, settingsXml, extensionsXml, mavenProperties);
        }
    ...
    private SessionRootBasedir(Path basedir, Path conf, Path settingsXml, Path extensionsXml, Path mavenProperties) {
        super(basedir);
